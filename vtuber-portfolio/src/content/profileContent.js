export const profileContent = {
  ...
  termsAndConditions: {
    ...
    sections: [
      ...
      {
        heading: 'Direito autoral e uso',
        subsections: [
          {
            subheading: 'Eu, Levi Bluu (o artista):',
            items: [
      ...
      {
        heading: 'O seguinte é considerado violação dos direitos autorais',
        items: [
          'Fazer NSFW pesado',
